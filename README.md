...
4. [No Code: Build Prediction Models with IBM Cloud Pak for Data AutoAI](#4-no-code-build-prediction-models-with-ibm-cloud-pak-for-data-autoai)
...
## 3. No Code: Build Prediction Models with IBM Cloud Pak for Data AutoAI
